...
Rectangle {
    ...
    property bool   _showCameraSection:             !_waypointsOnlyMode && !_controllerVehicle.apmFirmware
    ...
    ColumnLayout {
        ...
        Column {
            ...
            SectionHeader {
                ...
                visible:        !_waypointsOnlyMode  && QGroundControl.corePlugin.showAdvancedUI
                checked:        false
            }
            ...
            GridLayout {
                ...
                rowSpacing:     columnSpacing
                columns:        2
                visible:        vehicleInfoSectionHeader.visible && vehicleInfoSectionHeader.checked && QGroundControl.corePlugin.showAdvancedUI
            ...
            SectionHeader {
                ...
                visible:        !_vehicleHasHomePosition && QGroundControl.corePlugin.showAdvancedUI
                checked:        false
            }
            ...
            Column {
                ...
                anchors.right:  parent.right
                spacing:        _margin
                visible:        plannedHomePositionSection.checked && !_vehicleHasHomePosition && QGroundControl.corePlugin.showAdvancedUI
