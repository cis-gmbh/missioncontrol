        ...
        QGCFlickable {
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            FactCheckBox {
                                ...
                                visible:    _showLogReplayStatusBar.visible && QGroundControl.corePlugin.showAdvancedUI
                            ...
                            FactCheckBox {
                                ...
                                visible:    _alternateInstrumentPanel.visible && QGroundControl.corePlugin.showAdvancedUI
                            ...
                            FactCheckBox {
                                ...
                                visible:    _showAdditionalIndicatorsCompass.visible && QGroundControl.corePlugin.showAdvancedUI
                            ...
                            FactCheckBox {
                                ...
                                visible:    _lockNoseUpCompass.visible && QGroundControl.corePlugin.showAdvancedUI
                            ...
                            FactCheckBox {
                                ...
                                visible:    _showDumbCameraControl.visible && QGroundControl.corePlugin.showAdvancedUI
                            ...
                            GridLayout {
                                id:         videoGrid
                                columns:    2
                                visible:    _videoSettings.visible && QGroundControl.corePlugin.showAdvancedUI
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            FactCheckBox {
                                ...
                                visible:    _planViewSettings.takeoffItemNotRequired.visible && QGroundControl.corePlugin.showAdvancedUI
                            }
                        }
                    }
                        ...
                        Item {
                            ...
                            GridLayout {
                                ...
                                QGCLabel {
                                    ...
                                    visible: QGroundControl.settingsManager.appSettings.indoorPalette.visible && QGroundControl.corePlugin.showAdvancedUI
                                }
                                FactComboBox {
                                    Layout.preferredWidth:  _comboFieldWidth
                        ...
                        Item {
                            ...
                            ColumnLayout {
                                ...
                                FactCheckBox {
                                    ...
                                    fact:       _usePairing
                                    visible:    _usePairing.visible && QGroundControl.supportsPairing && QGroundControl.corePlugin.showAdvancedUI
                    ...
                    Item { width: 1; height: _margins; visible: telemetryLogSectionLabel.visible && QGroundControl.corePlugin.showAdvancedUI }
                    QGCLabel {
