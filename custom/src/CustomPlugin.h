...
private:
    ...
    void _addAnalyzeEntry(const QString& title, const char* qmlFile, const char* iconFile = nullptr);


private:
    CustomOptions*  _options = nullptr;
    QVariantList    _customSettingsList; // Not to be mixed up with QGCCorePlugin implementation
    QVariantList    _customAnalyzeList; // Not to be mixed up with QGCCorePlugin implementation
